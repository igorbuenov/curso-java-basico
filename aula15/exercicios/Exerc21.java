...
public class Exerc21 {
    public static void main(String[] args) {
        ...
        /*
        * Faça um programa para um caixa eletrônico. O programa deverá perguntar ao usuário o valor de saque
        * e depois informar quantas notas de cada valor serão fornecidas. As notas disponíveis serão as de 1,
        ...
        *
        * Exemplo 1: Para sacar a quantia de 256 reais, o programa fornece duas notas de 100, um anota de 50
