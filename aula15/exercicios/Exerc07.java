...
public class Exerc07 {
    public static void main(String[] args) {
        ...
        * Faça um programa que leia três números e mostre o maior e o menor deles.*/
        ...
        if (num1 < num2 && num1 < num3) {
            System.out.println("O primeiro número a ser digitado que é o " + num1 + " é o menor.");
        } else if (num2 < num3 && num2 < num1) {
            System.out.println("O segundo número a ser digitado que é o " + num2 + " é o  menor.");
        } else {
            System.out.println("O terceiro número a ser digitado que é o " + num3 + " é o menor.");
        }
